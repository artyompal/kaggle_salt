...
save_model_name = "../output/" + basic_name + '.model'
submission_file = "../output/" + basic_name + '.csv'
...
reduce_lr = ReduceLROnPlateau(monitor='my_iou_metric', mode='max', factor=0.5, patience=5, min_lr=3e-6, verbose=1)
...
# ious = np.array([get_iou_vector(y_valid, preds_valid > threshold) for threshold in tqdm(thresholds)])
# print(ious)
